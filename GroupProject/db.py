...
def export_to_sqlite():
    ...
    file_to_read = openpyxl.load_workbook('vacancy.xlsx', data_only=True)
    ...
    for row in range(2, sheet.max_row + 1):
        # Объявление списка
        data = []
        # Цикл по столбцам от 1 до 5 ( 5  включая)
    ...
    # 3. Запись в базу и закрытие соединения
        ...
        cursor.execute("INSERT INTO vacancy VALUES (?, ?, ?, ?, ?);", (data[0], data[1], data[2], data[3], data[4]))
